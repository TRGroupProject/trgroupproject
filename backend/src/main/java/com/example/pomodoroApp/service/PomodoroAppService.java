...
//    public URL getGoogleApiUrl(String uid);
    ...
    public String saveGoogleApiCalendarEvents(String uid, String googleUserId) throws URISyntaxException, ExecutionException, InterruptedException, TimeoutException;
